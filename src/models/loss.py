...
def bpr_loss(pos_score: torch.Tensor, neg_score: torch.Tensor, **kwargs) -> torch.Tensor:
    return -F.logsigmoid(pos_score - neg_score).mean()


def bce_loss(pos_score: torch.Tensor, neg_score: torch.Tensor, **kwargs) -> torch.Tensor:

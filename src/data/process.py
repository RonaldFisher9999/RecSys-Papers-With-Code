...
from data.datamodel import GraphModelData, MFModelData, BaseData
...
class DataProcessor:
    ...
    def process(self) -> BaseData:
        ...
        rating_train, rating_val, rating_test = self._split_data(rating_df,
    ...
    def _split_data(self, rating_df: pd.DataFrame, split_method: str,
                    test_ratio: float,
                    val_ratio: float
